...
def main():
    np.random.seed(42)
    path = "D:/polyp_seg/dataset/Kvasir-SEG-sessile"
    (train_x, train_y), (valid_x, valid_y) = load_data(path, split=0.2)

    create_dir("D:/polyp_seg/dataset/new_data_Kvasir-SEG-sessile/train/image/")
    create_dir("D:/polyp_seg/dataset/new_data_Kvasir-SEG-sessile/train/mask/")
    create_dir("D:/polyp_seg/dataset/new_data_Kvasir-SEG-sessile/valid/image/")
    create_dir("D:/polyp_seg/dataset/new_data_Kvasir-SEG-sessile/valid/mask/")

    augment_data(train_x, train_y, "D:/polyp_seg/dataset/new_data_Kvasir-SEG-sessile/train/", augment=True)
    augment_data(valid_x, valid_y, "D:/polyp_seg/dataset/new_data_Kvasir-SEG-sessile/valid/", augment=False)
